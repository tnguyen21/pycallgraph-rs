...
<p class="intro">
  ...
  &mdash; no Python runtime required. This page shows analysis results across
  popular open-source Python projects. Expand any project below to see its
...
<div class="section">
  ...
  <p class="section-desc">Summary of symbol-level analysis on each project. Click column headers to sort.</p>
  <table>
    <thead>
      <tr>
        <th>Project</th>
